...
#include "assert.h"
#include "seq.h"
#include "../CH10/array.h"
#include "../CH10/arrayrep.h"
#include "../CH5/mem.h"
...
static void expand(T seq) {
	...
	// After doubling the length of the underlying array, shift the circularly wrapped items from the start to the end
	if(seq->head > 0) {
